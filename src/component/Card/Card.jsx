...
const Card = ({ poster_path, release_date, title, overview, id, genres,popularity }) => {
  let img =
  ...
  return (
    <div key={id} Class="container-cards">
      ...
      <p Class="cards-info-text card-overview-text">{overview ? overview : 'Опис ще друкують=)'}</p>
